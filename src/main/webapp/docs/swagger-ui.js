...
function program9(depth0,data) {
  ...
  return "\n                    <div class='sandbox_header'>\n                        <input class='submit' style='visibility:hidden' name='commit' type='button' value='Try it out!' />\n                        <a href='#' class='response_hider' style='display:none'>Hide Response</a>\n                        <img alt='Throbber' class='response_throbber' src='images/throbber.gif' style='display:none' />\n                    </div>\n                    ";}
...
templates['resource'] = template(function (Handlebars,depth0,helpers,partials,data) {
  ...
  stack1 = foundHelper || depth0.name;
  console.log(stack1);
  buffer += "<div class='heading' id='ln" + stack1 + "'>\n    <h2>\n        <a href='#!/";  
  $('#menuOptions').append('<a href="#ln' + stack1 + '">/' + stack1 + '</a><label style="visibility:hidden">' + stack1 + '</label>');
  if(typeof stack1 === functionType) { stack1 = stack1.call(depth0, { hash: {} }); }
  else if(stack1=== undef) { stack1 = helperMissing.call(depth0, "name", { hash: {} }); }
